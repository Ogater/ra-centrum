        ...
        <div className={styles.rows}>
          ...
          <div className={styles.formBox}>
            <input
              ...
              type="text"
              placeholder={t("Введіть ваше ім’я прізвище")}
            />
            <input
              className={styles.inputField}
              type="email"
              placeholder={t("Введіть ваш e-mail")}
            />
            <input
              className={styles.inputField}
              type="text"
              placeholder={t("Напишіть ваше запитання")}
            />
            <button className={styles.submitButton}>{t("Надіслати")}</button>
          </div>
          */}
          ...
          <div className={styles.infoBox}>
            <div className={styles.infoRow}>
              ...
              <div className={styles.infoText}>{t("+380 63 041 6293")}</div>
            </div>
            ...
            <div className={styles.infoRow}>
              ...
              <div className={styles.infoText}>{t("office@ra-centrum.com")}</div>
            </div>
